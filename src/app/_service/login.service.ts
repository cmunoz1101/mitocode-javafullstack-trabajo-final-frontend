...
export class LoginService {
  ...
  // sessionStorage: Dura hasta que cierras la sesion, o cierres el browser (Ver en la pestaña Application de la consola del browser)
  // localStorage: Perdura más tiempo, mantener cuenta activa, recuerdame
